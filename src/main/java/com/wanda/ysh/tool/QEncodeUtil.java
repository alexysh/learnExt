 ...
 * @author yangshihong Mar 24, 2015 9:18:13 AM
 */
public class QEncodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = "tPZUWA3pzHn+NHFaanFGgw";
        ...
        System.out.println("cloudparking加密后：" + md5Encrypt("cloudparking"));
